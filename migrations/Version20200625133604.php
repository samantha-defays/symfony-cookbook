 ...
 */
final class Version20200625133604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, ingredients LONGTEXT NOT NULL, content LONGTEXT NOT NULL, preparation_time INT NOT NULL, cooking_time INT NOT NULL, utensils LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, illustration VARCHAR(255) DEFAULT NULL, INDEX IDX_DA88B1377E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
